...
class CfgVehicles
{
	...
	class FS_Cvetok_BASE: ZombieMaleBase
	{
		...
		model = "FS_4\1_ai\cvetok\cvetok.p3d";
		htMin = 6000;
		htMax = 8800;
		afMax = 5555;
		mfMax = 5555;
		...
		tBody = 5555;
		displayName = "Fleur?";
		descriptionShort = "il faut se méfier";
		class Cargo
		{
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FS_4\1_ai\Cvetok\data\cvetok_standart.paa"};
	};
	class FS_Cvetok_green: FS_Cvetok_BASE
	{
		scope = 2;
		model = "FS_4\1_ai\cvetok\cvetok_green.p3d";
		hiddenSelectionsTextures[] = {"FS_4\1_ai\Cvetok\data\cvetok_green.paa"};
	};
};
