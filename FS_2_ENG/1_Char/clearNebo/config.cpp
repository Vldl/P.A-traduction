...
class CfgVehicles
{
	...
	{
		scope = 2;
		model = "FS_2\1_Char\ClearNEbo\ClearNebo.p3d";
	};
	class FS_ClearNebo_Base: ZombieMaleBase
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 1000;
					healthLevels[] = {{1,{"FS_2\1_Char\clearNebo\data\ClearNeboMaterial.rvmat"}},{0.7,{"FS_2\1_Char\clearNebo\data\Damage.rvmat"}},{0.5,{"FS_2\1_Char\clearNebo\data\Damage2.rvmat"}},{0.3,{"FS_2\1_Char\clearNebo\data\Damage3.rvmat"}},{0,{"FS_2\1_Char\clearNebo\data\Damage3.rvmat"}}};
				};
			};
			class DamageZones
			{
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FS_2\1_char\clearnebo\data\clearnebo.paa"};
	};
};
