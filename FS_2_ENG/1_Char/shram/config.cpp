...
class CfgVehicles
{
	...
	{
		scope = 2;
		model = "FS_2\1_Char\shram\shram.p3d";
	};
	class FS_ShramVSS_Char: FS_Saharov
	{
		scope = 2;
		model = "FS_2\1_Char\shram\shram_Vss.p3d";
	};
	class FS_Plash_Zombie_Base: ZombieMaleBase
	{
		scope = 0;
		hiddenSelections[] = {"vkComFidovPublic"};
		model = "FS_2\1_Char\shram\Zmb_Plas.p3d";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 1000;
					healthLevels[] = {{1,{"FS_2\1_Char\shram\Data\Sha_plas.rvmat"}},{0.7,{"FS_2\1_Char\shram\Data\PlaDamage.rvmat"}},{0.5,{"FS_2\1_Char\shram\Data\PlaDamage2.rvmat"}},{0.3,{"FS_2\1_Char\shram\Data\PlaDamage3.rvmat"}},{0,{"FS_2\1_Char\shram\Data\PlaDamage3.rvmat"}}};
				};
			};
			class DamageZones
			{
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FS_2\1_Char\shram\Data\Sharm_plas.paa"};
	};
};
