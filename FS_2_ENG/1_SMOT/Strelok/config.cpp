...
class CfgVehicles
{
	...
	class FS_ST_combez_ColorBase: HuntingJacket_Autumn
	{
		...
		model = "\FS_2\1_smot\strelok\st_form_g.p3d";
		inventorySlot = "Body";
		...
		class ClothingTypes
		{
			male = "\FS_2\1_smot\strelok\st_form.p3d";
			female = "\FS_2\1_smot\strelok\st_form.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
	...
	class FS_ST_combez_pants_ColorBase: CargoPants_Beige
	{
		...
		model = "FS_2\1_smot\strelok\st_pants_g.p3d";
		inventorySlot = "Legs";
		simulation = "clothing";
		...
		class ClothingTypes
		{
			male = "FS_2\1_smot\strelok\st_pants.p3d";
			female = "FS_2\1_smot\strelok\st_pants.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
	...
	class FS_ST_combez_pants_Monolit: FS_ST_combez_pants_ColorBase
	{
		scope = 2;
		visibilityModifier = 0.95;
		hiddenSelectionsTextures[] = {"FV_ST_PACK\monolit\data\monolit","FV_ST_PACK\monolit\data\monolit","FV_ST_PACK\monolit\data\monolit"};
	};
