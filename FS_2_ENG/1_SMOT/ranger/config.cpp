...
class CfgVehicles
{
	...
	class FS_RangerJacket_ColorBase: HuntingJacket_Autumn
	{
		...
		model = "\FS_2\1_smot\ranger\ranger_jacket_g.p3d";
		inventorySlot = "Body";
		...
		class ClothingTypes
		{
			male = "\FS_2\1_smot\ranger\ranger_jacket.p3d";
			female = "\FS_2\1_smot\ranger\ranger_jacket.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
	...
	class FS_RangerPants_ColorBase: CargoPants_Beige
	{
		...
		model = "FS_2\1_smot\ranger\Ranger_pants_g.p3d";
		inventorySlot = "Legs";
		simulation = "clothing";
		...
		class ClothingTypes
		{
			male = "\FS_2\1_smot\ranger\Ranger_pants.p3d";
			female = "\FS_2\1_smot\ranger\Ranger_pants.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
