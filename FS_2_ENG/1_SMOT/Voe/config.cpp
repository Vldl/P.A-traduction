...
class CfgVehicles
{
	...
	class FS_OldMilitary_ColorBase: HuntingJacket_Autumn
	{
		...
		model = "\FS_2\1_smot\voe\voejacket_G.p3d";
		inventorySlot = "Body";
		...
		class ClothingTypes
		{
			male = "\FS_2\1_smot\voe\voejacket.p3d";
			female = "\FS_2\1_smot\voe\voejacket_F.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
	...
	class FS_OldMilitaryPants_ColorBase: CargoPants_Beige
	{
		...
		model = "\FS_2\1_smot\voe\voePants_G.p3d";
		inventorySlot = "Legs";
		simulation = "clothing";
		...
		class ClothingTypes
		{
			male = "\FS_2\1_smot\voe\voePants.p3d";
			female = "\FS_2\1_smot\voe\voePants_F.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
