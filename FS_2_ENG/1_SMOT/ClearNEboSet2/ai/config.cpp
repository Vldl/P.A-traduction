...
class CfgVehicles
{
	...
	{
		scope = 2;
		model = "FS_2\1_SMOT\ClearNEboSet2\CNchar.p3d";
	};
	class FS_ClearNeboType2_Base: ZombieMaleBase
	{
		scope = 0;
		hiddenSelections[] = {"vkComFidovPublic"};
		model = "FS_2\1_SMOT\ClearNEboSet2\CNzmb.p3d";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 1000;
					healthLevels[] = {{1,{"FS_2\1_SMOT\ClearNEboSet2\data\ClearNeboType2Mat.rvmat"}},{0.7,{"FS_2\1_SMOT\ClearNEboSet2\data\DamagCN.rvmat"}},{0.5,{"FS_2\1_SMOT\ClearNEboSet2\data\DamagCN2.rvmat"}},{0.3,{"FS_2\1_SMOT\ClearNEboSet2\data\DamagCN3.rvmat"}},{0,{"FS_2\1_SMOT\ClearNEboSet2\data\DamagCN3.rvmat"}}};
				};
			};
			class DamageZones
			{
