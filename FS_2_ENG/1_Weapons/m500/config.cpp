...
class cfgWeapons
{
	...
	{
		scope = 2;
		displayName = "FUSIL MOSSBERG 500";
		descriptionShort = "Le Mossberg-500 est l'un des fusils à plusieurs coups les plus courants - des fusils à pompe avec un rechargement à l'avant mobile. Sorti pour la première fois en 1961. Il est maintenant produit dans diverses modifications conçues à la fois pour la chasse et pour la police, les gardes de sécurité et l'autodéfense.";
		model = "\FS_2\1_weapons\m500\m500.p3d";
		animName = "ShotgunMp133";
		attachments[] = {""};
		itemSize[] = {5,2};
		weight = 1700;
		hiddenSelectionsTextures[] = {"fs_2\1_weapons\m500\data\m500.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
