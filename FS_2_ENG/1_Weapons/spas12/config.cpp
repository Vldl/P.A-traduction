...
class cfgWeapons
{
	...
	class FS_Spas12: FS_Spas12_ShotgunBase
	{
		scope = 2;
		displayName = "SPAS12";
		descriptionShort = "Le Franchi SPAS-12 est un fusil de chasse à double mode, ce qui signifie qu'il peut être utilisé comme une arme semi-automatique ou à pompe. Le basculement entre les modes de tir s'effectue en appuyant sur le bouton sous l'avant-bras, mais il est cassé... Fonctionne uniquement en mode manuel.";
		model = "\FS_2\1_weapons\spas12\spas12.p3d";
