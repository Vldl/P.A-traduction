...
class cfgWeapons
{
	...
	class FS_AA12: FS_AA12_Base
	{
		scope = 2;
		displayName = "AA-12";
		descriptionShort = "Le fusil de chasse automatique est un fusil de chasse créé par Maxwell Atchisson sur la base du précédent fusil d'assaut Atchisson.";
		model = "\FS_2\1_weapons\AA12\AA12.p3d";
		itemSize[] = {7,3};
		attachments[] = {""};
		class DamageSystem
		{
