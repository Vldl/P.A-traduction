...
class CfgVehicles
{
	...
	class FS_WolfZmb_base: AnimalBase
	{
		...
		scope = 0;
		model = "\fs_2\1_mutants\DogZMB\Dog.p3d";
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FV_ST_PACK\Mutants\slepdog\data\slep.paa"};
		hiddenSelectionsMaterials[] = {"FV_ST_PACK\Mutants\slepdog\data\slep.rvmat"};
	};
};
