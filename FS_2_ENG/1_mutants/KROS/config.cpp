...
class CfgVehicles
{
	...
	class FS_KrovososType2_Albinos: FS_KrovososType2_Base
	{
		...
		model = "fs_2\1_mutants\kros\kros.p3d";
		descriptionShort = "Mutant";
		hiddenSelectionsTextures[] = {"FS_2\1_mutants\KROS\data\kros_Olbinos.Paa"};
	};
	class FS_KrovososType2_Brown: FS_KrovososType2_Base
	{
		...
		model = "fs_2\1_mutants\kros\kros.p3d";
		descriptionShort = "Mutant";
		hiddenSelectionsTextures[] = {"FS_2\1_mutants\KROS\data\kros.Paa"};
	};
	class FS_KrovososType2_Volkodav: FS_KrovososType2_Base
	{
		scope = 2;
		displayName = "Bloodsucker Wolfhound";
		model = "fs_2\1_mutants\kros\kros_medved.p3d";
		descriptionShort = "Mutant";
		hiddenSelections[] = {"vkcomfidovpublic","FUR"};
		hiddenSelectionsTextures[] = {"FS_2\1_mutants\KROS\data\medved\kros_medved.Paa","FS_2\1_mutants\KROS\data\medved\fur_alpha_medved.Paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 7500;
					healthLevels[] = {{1,{"FS_2\1_mutants\KROS\data\medved\kros_medved.rvmat"}},{0.7,{"FS_2\1_mutants\KROS\data\medved\KrosMedvedDamage.rvmat"}},{0.5,{"FS_2\1_mutants\KROS\data\medved\KrosMedvedDamage2.rvmat"}},{0.3,{"FS_2\1_mutants\KROS\data\medved\KrosMedvedDamage3.rvmat"}},{0,{"FS_2\1_mutants\KROS\data\medved\KrosMedvedDamage3.rvmat"}}};
				};
			};
			class DamageZones
			{
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FS_2\1_mutants\KROS\data\medved\kros_medvedSer.Paa","FS_2\1_mutants\KROS\data\medved\fur_alpha_medvedSer.Paa"};
		displayName = "Bloodsucker Wolfhound";
	};
};
