...
class CfgVehicles
{
	...
	class FS_Izlome_Base: ZombieMaleBase
	{
		...
		model = "FS_2\1_mutants\izlom\izlom.p3d";
	...
	class FS_Izlome: FS_Izlome_Base
	{
		...
		hiddenSelectionsTextures[] = {"FS_2\1_mutants\izlom\data\izlom.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 2600;
					healthLevels[] = {{1,{"FS_2\1_mutants\izlom\data\izlom.rvmat"}},{0.7,{"FS_2\1_mutants\izlom\data\damage.rvmat"}},{0.5,{"FS_2\1_mutants\izlom\data\damage2.rvmat"}},{0.3,{"FS_2\1_mutants\izlom\data\damage2.rvmat"}},{0,{"FS_2\1_mutants\izlom\data\damage3.rvmat"}}};
				};
			};
			class DamageZones
			{
