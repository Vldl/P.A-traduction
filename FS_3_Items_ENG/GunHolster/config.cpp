...
class CfgVehicles
{
	...
	class FS_GunHolsterPro: HuntingJacket_Autumn
	{
		...
		descriptionShort = "Holster avec pochette";
		model = "FS_3_Items\GunHolster\GunHolster_g.p3d";
		inventorySlot[] = {"Hips"};
		attachments[] = {"pistol"};
		...
		class ClothingTypes
		{
			male = "FS_3_Items\GunHolster\GunHolster.p3d";
			female = "FS_3_Items\GunHolster\GunHolster.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
