...
class CfgVehicles
{
	...
	class FS_KrovososArmor: FS_KrovososType2_Base
	{
		...
		model = "FS_3_Items\1_AI\KrovososArm\KrovososArm.p3d";
		descriptionShort = "Bloodsucker Golbin";
		hiddenSelections[] = {"vkcomfidovpublic"};
		hiddenSelectionsTextures[] = {"fs_3_items\1_ai\krovososarm\data\kroarm_co.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 7500;
					healthLevels[] = {{1,{"FS_3_Items\1_AI\KrovososArm\data\KroArm_mat.rvmat"}},{0.7,{"FS_3_Items\1_AI\KrovososArm\data\damaged\KroArmDamage1.rvmat"}},{0.5,{"FS_3_Items\1_AI\KrovososArm\data\damaged\KroArmDamage2.rvmat"}},{0.3,{"FS_3_Items\1_AI\KrovososArm\data\damaged\KroArmDamage3.rvmat"}},{0,{"FS_3_Items\1_AI\KrovososArm\data\damaged\KroArmDamage3.rvmat"}}};
				};
			};
			class DamageZones
			{
