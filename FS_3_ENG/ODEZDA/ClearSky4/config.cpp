...
class CfgVehicles
{
	...
	class FS_ClearSkyType4_Jacket_ColorBase: HuntingJacket_Autumn
	{
		...
		model = "FS_3\ODEZDA\ClearSky4\ClearSkyJacket_g.p3d";
		inventorySlot = "Body";
		...
		class ClothingTypes
		{
			male = "FS_3\ODEZDA\ClearSky4\ClearSkyJacket.p3d";
			female = "FS_3\ODEZDA\ClearSky4\ClearSkyJacket_f.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
	...
	class FS_ClearSkyType4_Pants_ColorBase: CargoPants_Beige
	{
		...
		model = "FS_3\ODEZDA\ClearSky4\ClearSkyPants_g.p3d";
		inventorySlot = "Legs";
		simulation = "clothing";
		...
		class ClothingTypes
		{
			male = "FS_3\ODEZDA\ClearSky4\ClearSkyPants.p3d";
			female = "FS_3\ODEZDA\ClearSky4\ClearSkyPants_f.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
