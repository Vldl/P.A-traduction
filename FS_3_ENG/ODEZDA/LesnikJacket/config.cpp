...
class CfgVehicles
{
	...
	{
		displayName = "Ancien chapeau d'officier";
		descriptionShort = "Ancien chapeau d'officier.";
		model = "FS_3\ODEZDA\LesnikJacket\cap_g.p3d";
		...
		class ClothingTypes
		{
			male = "FS_3\ODEZDA\LesnikJacket\cap.p3d";
			female = "FS_3\ODEZDA\LesnikJacket\cap.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
	...
	class FS_Forest_Jacket_ColorBase: HuntingJacket_Autumn
	{
		...
		descriptionShort = "Vieux sifflet";
		model = "FS_3\ODEZDA\LesnikJacket\Jacket_Forest_g.p3d";
		inventorySlot = "Body";
		...
		class ClothingTypes
		{
			male = "FS_3\ODEZDA\LesnikJacket\Jacket_Forest.p3d";
			female = "FS_3\ODEZDA\LesnikJacket\Jacket_Forest_f.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
