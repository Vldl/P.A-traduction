...
class CfgVehicles
{
	...
	class FS_DogZMB_base: AnimalBase
	{
		...
		scope = 0;
		model = "\FS_3\1_Muta\DogZ\Dogz.p3d";
		displayName = "Zombie Dog ";
		descriptionShort = "Les pseudo-chiens sont un type de mutant relativement courant descendant de souches d'ADN de loup, d'ours et d'humain, tout en ne ressemblant qu'aux chiens visuellement. Contrairement à leur parent le chien aveugle, qui est clairement un effet secondaire de mutations aléatoires, on pense que les pseudo-chiens possèdent un historique de reproduction expérimental, leurs origines possibles remontant bien avant la deuxième catastrophe.";
