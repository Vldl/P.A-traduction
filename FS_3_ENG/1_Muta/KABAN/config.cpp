...
class CfgVehicles
{
	...
	class FS_Kaban_base: AnimalBase
	{
		...
		scope = 0;
		model = "\FS_3\1_Muta\kaban\koban.p3d";
	...
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FS_3_Data\kaban\data\kaban_co.paa"};
	};
	class FS_Kaban_black: FS_Kaban_base
	{
		scope = 2;
		hiddenSelectionsTextures[] = {"FS_3_Data\kaban\data\kaban_black_co.paa"};
	};
};
