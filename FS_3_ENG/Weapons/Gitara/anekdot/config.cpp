...
class cfgWeapons
{
	...
	class FS_AnekdotsSound_Bandit: FS_AnekdotsSound_Base
	{
		...
		attachments[] = {};
		itemSize[] = {1,1};
		hiddenSelectionsTextures[] = {"FS_3_Data\girara\anekdot\bandit.paa"};
		class Single: Mode_SemiAuto
		{
	...
	class FS_AnekdotsSound_Svoboda: FS_AnekdotsSound_Base
	{
		...
		attachments[] = {};
		itemSize[] = {1,1};
		hiddenSelectionsTextures[] = {"FS_3_Data\girara\anekdot\svoboda.paa"};
		class Single: Mode_SemiAuto
		{
	...
	class FS_AnekdotsSound_Army: FS_AnekdotsSound_Base
	{
		...
		attachments[] = {};
		itemSize[] = {1,1};
		hiddenSelectionsTextures[] = {"FS_3_Data\girara\anekdot\voen.paa"};
		class Single: Mode_SemiAuto
		{
