...
class cfgWeapons
{
	...
	class FS_MP153_baikal: FS_MP153_base
	{
		...
		descriptionShort = "MP-153 - Fusil de chasse à canon lisse à chargement automatique russe, communément appelé Murka ---- FS MOD";
		model = "\FS_3\Weapons\baikal\baikal.p3d";
		attachments[] = {""};
		itemSize[] = {9,3};
		class DamageSystem
		{
